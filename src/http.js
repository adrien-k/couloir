...
class HttpMessage {
  ...
  onData(chunk) {
    ...
    // We received a chunk that did not qualify as http head.
    // If it did not contain HTTP/ it 
...
export const createProxy =
  (clientSocket, serverSocket, { end = true, onServerSocketEnd, onClientSocketEnd } = {}) =>
  async (handler) => {
    let open = true;
